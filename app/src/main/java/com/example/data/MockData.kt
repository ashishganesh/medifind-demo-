...
object MockData {
    ...
    val samplePharmacies = listOf(
        Pharmacy(
            ...
            address = "Shop #14, M.G. Marg, Hazratganj, Lucknow, UP",
            latitude = 26.8480,
            longitude = 80.9470,
            distanceKm = 1.2,
        ...
        Pharmacy(
            ...
            address = "Sector B, Near Post Office, Aliganj, Lucknow, UP",
            latitude = 26.8920,
            longitude = 80.9442,
            distanceKm = 2.4,
        ...
        Pharmacy(
            id = "pharm_3",
            name = "KGMU Hospital Central Pharmacy",
            address = "King George's Medical University Campus, Chowk, Lucknow, UP",
            latitude = 26.8682,
            longitude = 80.9129,
            distanceKm = 3.8,
            phone = "+91 0522 2257540",
        ...
        Pharmacy(
            id = "pharm_4",
            name = "Apollo Pharmacy Hazratganj",
            address = "Near Samarpan Hospital, Lucknow, UP",
            latitude = 26.8450,
            longitude = 80.9480,
            distanceKm = 1.8,
            phone = "+91 0522 4001122",
            openStatus = "24/7 Open",
            timing = "24 Hours Open",
            isVerified = true,
        ...
        Pharmacy(
            id = "pharm_5",
            name = "Sahara Hospital Inhouse Pharmacy",
            address = "Viraj Khand 1, Gomti Nagar, Lucknow, UP",
            latitude = 26.8560,
            longitude = 80.9980,
            distanceKm = 4.5,
            phone = "+91 0522 6780000",
            openStatus = "24/7 Open",
            timing = "24 Hours Open",
            isVerified = true,
            ...
            availableMedicinesCount = 280
        ),
        Pharmacy(
            id = "pharm_6",
            name = "Lucknow Medicos & Chemist",
            address = "Patrakarpuram Crossing, Gomti Nagar, Lucknow, UP",
            latitude = 26.8510,
            longitude = 80.9900,
            distanceKm = 5.1,
        ...
        Pharmacy(
            ...
            address = "Aminabad Market, Lucknow, UP",
            latitude = 26.8430,
            longitude = 80.9280,
            distanceKm = 3.1,
            ...
            availableMedicinesCount = 110
        ),
        Pharmacy(
            id = "pharm_8",
            name = "Care Medicos",
            address = "Chowk Square, Near Akbari Gate, Lucknow, UP",
            latitude = 26.8690,
            longitude = 80.9140,
            distanceKm = 4.0,
            ...
            openStatus = "Open now",
            timing = "8:00 AM - 11:00 PM",
            isVerified = false, // pending re-verification demo
            facilityType = "Retail Pharmacy",
            rating = 4.2,
            lastUpdated = "3 hours ago",
            availableMedicinesCount = 75
        )
    )
